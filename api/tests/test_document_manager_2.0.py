...
from ..utils.document_manager import DocumentManager, DocumentError, DocumentValidationError
...
class TestDocumentManager:
    ...
    def test_get_document_success(self, document_manager, mock_db):
        ...
        mock_cursor.fetchone.return_value = (1, 123, 'tax_return', 'test.pdf', '{}', '2023-01-01')
