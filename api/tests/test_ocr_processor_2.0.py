...
class TestOCRProcessor:
    ...
    def test_extract_date_multiple_formats(self, ocr_processor):
        date_texts = ["12/25/2023", "2023-12-25", "25 Dec 2023"]
    ...
    def test_extract_total_multiple_formats(self, ocr_processor):
        total_texts = ["TOTAL: $123.45", "Amount Due: $123.45", "Total Due: $123.45"]
    ...
    def test_process_receipt_api_error(self, ocr_processor, mock_vision_client):
        mock_vision_client.return_value.text_detection.side_effect = Exception(
            "Application Programming Interface Error"
        )
