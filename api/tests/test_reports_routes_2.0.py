...
class TestReportsRoutes:
    def test_generate_report_success(self, client):
        response = client.post('/reports/tax_summary',
                             json={
                                 'type': 'tax_summary',
                                 'params': {
                                     'year': 2023,
    ...
    def test_generate_tax_summary_success(self, client, mock_db):
        ...
        response = client.post('/tax-summary',
                             json={
                                 'user_id': 123,
                                 'year': 2023
                             })
    ...
    def test_generate_schedule_c_success(self, client, mock_db):
        ...
        response = client.post('/irs/schedule-c',
                             json={
                                 'user_id': 123,
                                 'year': 2023
                             })
    ...
    def test_generate_custom_report_success(self, client):
        response = client.post('/custom-report',
                             json={
                                 'user_id': 123,
    ...
    def test_analyze_tax_savings_success(self, client):
        response = client.post('/tax-savings',
                             json={
                                 'user_id': 123,
                                 'year': 2023
                             })
    ...
    def test_generate_advanced_analytics_success(self, client, mock_db):
        ...
        response = client.post('/advanced-analytics',
                             json={
                                 'user_id': 123,
                                 'year': 2023
                             })
    ...
    def test_prediction_accuracy(self, client, mock_db):
        ...
        assert data['predictions']['confidence'] > 0.5  # Assuming good prediction confidence
