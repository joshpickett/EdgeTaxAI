...
def test_create_expense_entry_success(
    expense_integration, mock_database, sample_expense_data
):
    ...
    result = expense_integration.create_expense_entry(
        sample_expense_data, user_id="123"
    )
...
def test_update_expense_entry_success(
    expense_integration, mock_database, sample_expense_data
):
