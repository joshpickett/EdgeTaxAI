...
def test_get_earnings_summary_success(analytics_helper, mock_database, sample_earnings_data):
    ...
    assert result['average_per_transaction'] == pytest.approx(20.60, 0.01)  # 1750.75 / 85
...
def test_get_earnings_summary_with_period(analytics_helper, mock_database, sample_earnings_data):
...
def test_get_expense_analysis_success(analytics_helper, mock_database, sample_expenses_data):
...
def test_get_expense_analysis_with_period(analytics_helper, mock_database, sample_expenses_data):
...
def test_get_comprehensive_report(mock_tax_calculator, mock_trip_analyzer, 
                                analytics_helper, mock_database, 
                                sample_earnings_data, sample_expenses_data):
