...
def test_verify_compliance_missing_docs(irs_compliance):
    ...
    expense = {"category": "meals", "amount": 100.00, "date": "2023-01-01"}
...
def test_verify_compliance_unknown_category(irs_compliance):
    ...
    expense = {"category": "unknown", "amount": 100.00}
...
def test_compliance_rules_initialization(irs_compliance):
    ...
    assert isinstance(
        irs_compliance.compliance_rules["deduction_limits"]["meals"], Decimal
    )
