...
async def test_process_batch_success(batch_processor, sample_files):
    ...
    with patch.object(
        batch_processor, "process_single_file", new_callable=AsyncMock
    ) as mock_process:
