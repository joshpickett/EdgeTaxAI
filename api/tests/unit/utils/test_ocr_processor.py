...
def test_process_receipt_success(
    ocr_processor, mock_vision_client, sample_receipt_image, mock_vision_response
):
...
def test_extract_date_multiple_formats(ocr_processor):
    ...
    dates = ["01/15/2023", "01-15-2023", "15 Jan 2023"]
...
def test_extract_total_multiple_formats(ocr_processor):
    ...
    texts = ["TOTAL: $16.98", "Amount Due $16.98", "Total Due: $16.98"]
