...
class AnalyticsIntegration:
    ...
    def get_user_analytics(
        self, user_id: int, period: Optional[tuple] = None
    ) -> Dict[str, any]:
    ...
    def get_platform_comparison(self, user_id: int, platforms: list) -> Dict[str, any]:
        ...
        try:
            ...
            return {
                ...
                "top_platform": (
                    max(platform_metrics.items(), key=lambda x: x[1]["total_earnings"])[
                        0
                    ]
                    if platform_metrics
                    else None
    ...
    def get_earnings_trends(
        ...
        try:
            ...
            return {
                ...
                "average_per_period": (
                    round(sum(t["total_earnings"] for t in trends) / len(trends), 2)
                    if trends
                    else 0
                ),
            }
