...
class AITransactionAnalyzer:
    ...
    def analyze_transaction(self, transaction: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logging.error(f"Error in artificial intelligence transaction analysis: {exception}")
            return {
    ...
    def _parse_ai_response(self, response: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if 'confidence: ' in response.lower():
                confidence_part = response.lower().split('confidence: ')[1].split('\n')[0]
                try:
            ...
            logging.error(f"Error parsing artificial intelligence response: {exception}")
            return {
                'is_business_expense': False,
                'is_business_income': False,
                'confidence_score': 0.0,
