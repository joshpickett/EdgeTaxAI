...
class ScheduleTriggerService:
    ...
    def __init__(self):
        ...
        self.thresholds = {
            ...
            'form_8829': {
                'min_area': 0,  # Any dedicated space
                'exclusive_use': True
            }
        }
    ...
    def _needs_schedule_c(self, tax_data: Dict[str, Any]) -> bool:
        ...
        self_employment_income = Decimal(str(
            tax_data.get('income_sources', {}).get('self_employment', 0)
        ))
    ...
    def _needs_schedule_se(self, tax_data: Dict[str, Any]) -> bool:
        ...
        net_earnings = Decimal(str(
            tax_data.get('income_sources', {}).get('net_earnings', 0)
        ))
    ...
    def _needs_schedule_e(self, tax_data: Dict[str, Any]) -> bool:
        ...
        rental_income = Decimal(str(
            tax_data.get('income_sources', {}).get('rental', 0)
        ))
    ...
    def _qualifies_for_8829(self, tax_data: Dict[str, Any]) -> bool:
        ...
        return (
            area_used > self.thresholds['form_8829']['min_area'] and
            exclusive_use == self.thresholds['form_8829']['exclusive_use']
        )
    ...
    def _generate_analysis(
        ...
        if 'SCHEDULE_SE' in required_schedules:
            analysis['schedule_se'] = {
                ...
                'net_earnings': tax_data.get('income_sources', {}).get('net_earnings', 0)
            }
