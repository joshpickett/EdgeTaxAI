...
class TaxReviewService:
        ...
        try:
            ...
            return {
                ...
                "recommendations": self._generate_recommendations(
                    calculations, document_status, schedule_review, deduction_review
                ),
            }
                        ...
                        deductions.append(
                            {
                                ...
                                "documentation": self._check_deduction_documentation(
                                    deduction
                                ),
    ...
    def _check_deduction_documentation(
        ...
        return {
            "status": (
                "complete"
                if all(doc in submitted_docs for doc in required_docs)
                else "incomplete"
            ),
