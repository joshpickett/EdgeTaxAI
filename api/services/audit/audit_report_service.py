...
class AuditReportService:
    ...
    async def generate_security_report(
        ...
        try:
            ...
            security_events = await self.db.query(AuditLog).filter(
                AuditLog.created_at.between(start_date, end_date),
    ...
    def _detect_suspicious_agents(self, agent_counts: Dict[str, int]) -> List[Dict[str, Any]]:
    ...
    def _find_peak_activity(self, audit_logs: List[AuditLog]) -> Dict[str, Any]:
        ...
        return {
            'timestamp': peak_hour[0].isoformat(),
