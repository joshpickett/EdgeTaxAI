...
class RealTimeValidator:
    ...
    def _validate_required(self, value: Any) -> Dict[str, Any]:
        ...
        return {
            'is_valid': is_valid,
            'errors': [] if is_valid else [{'type': 'required', 'message': 'This field is required'}],
            'warnings': []
        }
    ...
    def _validate_format(self, value: Any, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            'is_valid': is_valid,
            'errors': [] if is_valid else [{'type': 'format', 'message': params.get('message', 'Invalid format')}],
            'warnings': []
        }
