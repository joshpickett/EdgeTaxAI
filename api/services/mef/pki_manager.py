...
class PKIManager:
    ...
    def generate_certificate(
        self, private_key: rsa.RSAPrivateKey, organization_name: str
    ) -> x509.Certificate:
        ...
        try:
            subject = issuer = x509.Name(
                [
                    ...
                    x509.NameAttribute(
                        NameOID.COMMON_NAME,
                        f"{organization_name} Modernized e-File Certificate",
                    ),
                ]
            )
    ...
    def save_credentials(
        self, private_key: rsa.RSAPrivateKey, certificate: x509.Certificate
    ) -> None:
