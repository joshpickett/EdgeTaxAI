...
class AmendmentTracker:
    ...
    async def create_amendment(self, 
                             ...
                             amendment_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _generate_amendment_xml(self, 
                              original_xml: str,
                              amendment_data: Dict[str, Any]) -> str:
        """Generate amendment XML"""
        try:
            # Parse original XML
