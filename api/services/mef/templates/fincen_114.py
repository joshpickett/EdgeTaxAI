...
class FinCEN114Template(BaseMeFTemplate):
    ...
    def _add_foreign_accounts(
        self, parent: ElementTree.Element, accounts: List[Dict[str, Any]]
    ) -> None:
    ...
    def _add_joint_owners(
        self, parent: ElementTree.Element, owners: List[Dict[str, Any]]
    ) -> None:
        ...
        for owner in owners:
            ...
            taxpayer_identification_number = ElementTree.SubElement(
                owner_element, "TIN"
            )
