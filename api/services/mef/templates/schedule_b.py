...
class ScheduleBTemplate(BaseScheduleTemplate):
    ...
    def _add_interest_income(self, parent: ElementTree.Element, data: Dict[str, Any]) -> None:
    ...
    def _add_dividend_income(self, parent: ElementTree.Element, data: Dict[str, Any]) -> None:
    ...
    def _add_foreign_accounts(self, parent: ElementTree.Element, data: Dict[str, Any]) -> None:
