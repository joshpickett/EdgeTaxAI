...
class Form2555Template(BaseMeFTemplate):
    ...
    def _add_foreign_address(self, parent: ElementTree.Element, data: Dict[str, Any]) -> None:
    ...
    def _add_employer_info(self, parent: ElementTree.Element, data: Dict[str, Any]) -> None:
    ...
    def _add_foreign_income(self, parent: ElementTree.Element, data: Dict[str, Any]) -> None:
    ...
    def _add_housing_exclusion(self, parent: ElementTree.Element, data: Dict[str, Any]) -> None:
