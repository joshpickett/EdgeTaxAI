...
class Form8938Template(BaseMeFTemplate):
    ...
    def _add_foreign_assets(self, parent: ElementTree.Element, assets: List[Dict[str, Any]]) -> None:
    ...
    def _add_asset_info(self, parent: ElementTree.Element, data: Dict[str, Any]) -> None:
        """Add detailed asset information"""
        # Asset description
    ...
    def _add_acquisition_info(self, parent: ElementTree.Element, data: Dict[str, Any]) -> None:
