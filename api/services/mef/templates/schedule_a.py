...
class ScheduleATemplate(BaseScheduleTemplate):
    ...
    def _add_medical_expenses(self, parent: ElementTree.Element, data: Dict[str, Any]) -> None:
    ...
    def _add_taxes_paid(self, parent: ElementTree.Element, data: Dict[str, Any]) -> None:
        """Add taxes paid"""
    ...
    def _add_interest_paid(self, parent: ElementTree.Element, data: Dict[str, Any]) -> None:
        """Add interest paid"""
    ...
    def _add_charitable_contributions(self, parent: ElementTree.Element, data: Dict[str, Any]) -> None:
    ...
    def _add_casualty_losses(self, parent: ElementTree.Element, data: Dict[str, Any]) -> None:
        """Add casualty and theft losses"""
        total = ElementTree.SubElement(parent, 'TotalLoss')
        total.text = str(data.get('total', '0.00'))
        
        insurance_reimbursement = ElementTree.SubElement(parent, 'InsuranceReimbursement')
        insurance_reimbursement.text = str(data.get('insurance_reimbursement', '0.00'))
    
    def _add_miscellaneous_deductions(self, parent: ElementTree.Element, data: Dict[str, Any]) -> None:
