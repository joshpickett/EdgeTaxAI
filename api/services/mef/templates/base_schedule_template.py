...
class BaseScheduleTemplate(BaseMeFTemplate):
    ...
    def generate(self, data: Dict[str, Any]) -> str:
        ...
        if not self.validate_xml(xml_string, schema_file):
            raise ValueError(f"Generated Schedule {self.schedule_type} XML failed schema validation")
    ...
    def _add_schedule_content(self, parent: ElementTree.Element, data: Dict[str, Any]) -> None:
        ...
        raise NotImplementedError("Schedule content must be implemented by child classes")
