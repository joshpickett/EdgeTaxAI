...
class Form1099KTemplate(BaseMeFTemplate):
    ...
    def generate(self, data: Dict[str, Any]) -> str:
        ...
        payment_settlement_entity_info = ElementTree.SubElement(
            form_1099k, "PaymentSettlementEntityInfo"
        )
    ...
    def _add_payment_settlement_entity_info(
    ...
    def _add_form_metadata(
        self, parent: ElementTree.Element, metadata: Dict[str, Any]
    ) -> None:
        """Add form metadata"""
        if not metadata:
            return
    ...
    def _add_transaction_info(
        ...
        federal_tax_withheld.text = str(
            transaction_data.get("federalTaxWithheld", "0.00")
        )

    def _add_state_tax_info(
        self, parent: ElementTree.Element, data: Dict[str, Any]
    ) -> None:
        ...
        state_identification_number = ElementTree.SubElement(
            parent, "StateIdentificationNumber"
        )
