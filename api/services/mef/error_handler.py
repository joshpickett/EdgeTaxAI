...
class MEFErrorHandler:
    def __init__(self):
        ...
        self.retry_limits = {"transmission": 3, "validation": 2, "acknowledgment": 3}

    async def handle_submission_error(
        self, submission: MeFSubmission, error: Exception
    ) -> Dict[str, Any]:
    ...
    async def _handle_retry(
        self, submission: MeFSubmission, error_details: Dict[str, Any]
    ) -> Dict[str, Any]:
