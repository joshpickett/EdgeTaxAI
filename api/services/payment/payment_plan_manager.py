...
class PaymentPlanManager:
    ...
    def create_payment_plan(self, 
        ...
        monthly_payment = max(
            (total_owed / months).quantize(Decimal('0.01')),
            self.min_payment
        )
    ...
    def calculate_plan_options(self, 
                             total_owed: Decimal) -> List[Dict[str, Any]]:
    ...
    def _calculate_short_term_plan(self, 
                                 total_owed: Decimal) -> Dict[str, Any]:
    ...
    def _calculate_long_term_plan(self, 
                                total_owed: Decimal,
