...
class FormOptimizationService:
    ...
    async def analyze_optimization_opportunities(
        self, user_id: int, form_type: str, data: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "total_potential_savings": self._calculate_total_savings(
                    credit_opportunities, deduction_opportunities
                ),
    ...
    def _generate_recommendations(
        ...
        for opportunity in (
            credit_opportunities.get("opportunities", [])
        ...
        return sorted(
            recommendations, key=lambda x: x["potential_savings"], reverse=True
        )
    ...
    def _prioritize_opportunities(
        ...
        for opportunity in opportunities:
            opportunity["priority"] = self._calculate_priority(
                opportunity["potential_savings"]
            )
