...
class PaymentIntegrationService:
    ...
    async def initialize_payment_options(
        ...
        try:
            ...
            tax_calculation = await self.payment_calculator.calculate_total_tax_liability(
                tax_data
            )
            ...
            if tax_data.get('requires_estimated_tax'):
                estimated_payments = await self.estimated_tax_tracker.calculate_estimated_payment(
                    tax_data
                )
