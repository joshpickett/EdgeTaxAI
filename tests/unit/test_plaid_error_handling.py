...
def test_plaid_api_error_handling(client, mocker):
    ...
    mocker.patch("api.routes.bank_routes.plaid_client.transactions_get", side_effect=Exception("Plaid API error"))

    response = client.get("/plaid/transactions", query_string={
        "user_id": "1",
